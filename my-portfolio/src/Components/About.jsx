    ...
    <div id='About' className='h-4/5 py-15'>
      ...
      <div className=' w-full sm:flex xl:w-7/10 xl:mx-auto pt-10'>
        ...
        <div data-aos="slide-left" className='text-lg px-5 sm:w-3/5 sm:px-10'>
          <p>I am a 4th-year Electronics and Communication student at <a className='text-blue-600' href="https://nitsri.ac.in/">National Institute of Technology, Srinagar</a>, skilled in frontend technologies including HTML, CSS, JavaScript, and React, as well as backend development with Django.</p>
          <br></br>
